...
- [HLS, DASH](#hls-dash)
- [FTL](#ftl) - Fast Than Light Protocol
- [AV1 Codec](#av1-codec)
- [Game Streaming](#game-streaming)
- [3D Streaming](#3d-streaming)
- [WebUSB](#webusb)
- [Web Authentication](#web-authentication) - WebAuthn
...
- 2018/07/07 [WebUSB API lets you Access USB Devices over the Internet](https://www.element14.com/community/groups/embedded/blog/2018/07/06/webusb-api-lets-you-access-usb-devices-over-the-internet)
...
- [ASUS WebStorage-소개](https://www.asus.com/kr/support/FAQ/1009347/)
...
- 2017/04/05 [WebGPU Prototype and Demos](https://webkit.org/blog/7504/webgpu-prototype-and-demos/) - WebMetal
...
- [Enabling WebGPU on iOS 11](https://mil-tokyo.github.io/webdnn/docs/tips/enable_webgpu_ios.html)
...
- [kvark/webgpu-servo](https://github.com/kvark/webgpu-servo) - WebGPU prototope in Servo browser
- [XimingCheng/webgpu](https://github.com/XimingCheng/webgpu) - webgpu GPU code implementation, including CUDA, OpenCL, OpenACC and C++ AMP
...
- 2019/03/20 [WebRTC 시작하기 자습서 (1) | WebRTC Signaling Server 설정](https://segmentfault.com/a/1190000018575278) : 일본
...
### Information
- Mixer: [Blog](https://blog.mixer.com/)
...
- [Open source releases from Microsoft](https://opensource.microsoft.com/): [mixer](https://opensource.microsoft.com/?tag=mixer)
...
### History
- [https://cloud.google.com/solutions/gaming/cloud-game-infrastructure](클라우드 게임 인프라 개요)
...
- 2017 [Security analysis of steganalyzers](https://tel.archives-ouvertes.fr/tel-01781419/document)
